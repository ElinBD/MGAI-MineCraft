...
def north_south_roof(level, box, options, length_x, height_y, length_z, base_x, base_y, base_z, facade_type):
    ...
    if facade_type == 1: # Large staircase facade
        y_r = base_y+height_y
        for x in range(base_x, x_center):
        ...
        # y_r = facade_height
        # for x in range(x_center, x_center+side_parts, -1):
        #     y = facade_height
        #     while y < y_r:
        #         if level.blockAt(x, int(math.ceil(y)), base_z) != 0:
        #             utilityFunctions.setBlock(level, (4,0), x, int(math.ceil(y)), base_z)
        #         else:
        #             # pass
        #             utilityFunctions.setBlock(level, (44,0), x, int(math.ceil(y)), base_z)
        #         y += 0.5
        #     y_r += 0.5
...
def build_house(level, box, options, length_x, height_y, length_z, base_x, base_y, base_z, door_loc, facade_type):
    #Walls of the house:
    ...
    if door_loc % 2 == 0:
        ...
        #door in N/S section
        north_south_roof(level, box, options, length_x, height_y, length_z, base_x, base_y, base_z, facade_type)
    ...
    # Door stuff...
    # utilityFunctions.setBlock(level, ("minecraft:stone", door_loc), door_x, base_y, door_z)
    # level.setBlockAt(door_x, base_y+1, door_z, "minecraft:granite")
...
def perform(level, box, options):
    ...
    # print level.blocktypes['minecraft:stone'] # TODO????
    #'''

    build_house(level, box, options, length_x, height_y, length_z, base_x, base_y, base_z, door_loc, facade_type)

...
def windows(level, pallete, length_x, height_y, length_z, no_floors, window_width, door_x):
    x_center = length_x/2
    x_west = x_center - 1 if length_x % 2 == 0 else x_center
...
def build_house(length_x, height_y, length_z, no_floors, facade_type):
    ...
    #Determine window width depending on length_x:
    ...
    windows(level, pallete, length_x, height_y, length_z, no_floors, window_width, door_x)
    #windows(level, pallete, length_x, height_y, length_z, base_x, temp_base_y, base_z, facade_type, door_x, base_y, no_floors, y_r)
